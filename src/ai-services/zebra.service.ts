...
@Injectable()
export class ZebraService extends BaseAssistantService {
    modelName = 'zebra';
    description = `Zebra is an AI assistant that has the ability to summarize conversation history 
to  summarize previous conversations.`;
    ...
    public async generateResponse(
        ...
        const { ConversationSummaryMemory, ChatMessageHistory, ConversationSummaryBufferMemory  } =
