...
export class AntEaterService extends BaseAssistantService {
    ...
    public async generateResponse(
        ...
        const { ConversationSummaryMemory, BufferMemory, ConversationSummaryBufferMemory, CombinedMemory, ChatMessageHistory } =
        ...
        // Prompt Template
        const prompt = PromptTemplate.fromTemplate(`The following is a friendly conversation between a human and an AI. 
